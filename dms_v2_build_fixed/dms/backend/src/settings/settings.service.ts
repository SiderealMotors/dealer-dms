...
export class SettingsService {
  ...
  async updateSettings(dto: UpdateDealerSettingsDto) {
    return this.prisma.dealerSettings.upsert({
      ...
      update: {
        ...dto,
        hstRate: dto.hstRate != null ? new Decimal(dto.hstRate) : undefined,
        defaultOmvicFee: dto.defaultOmvicFee != null ? new Decimal(dto.defaultOmvicFee) : undefined,
      },
      create: {
        id: 'singleton',
        ...dto,
        hstRate: dto.hstRate != null ? new Decimal(dto.hstRate) : new Decimal(0.13),
        defaultOmvicFee: dto.defaultOmvicFee != null ? new Decimal(dto.defaultOmvicFee) : new Decimal(75),
      },
    });
  }
  ...
  async upsertCommissionRule(userId: string, dto: {
    ...
    return this.prisma.commissionRule.upsert({
      ...
      update: {
        ...
        flatAmount: dto.flatAmount != null ? new Decimal(dto.flatAmount) : null,
        percentOfProfit: dto.percentOfProfit != null ? new Decimal(dto.percentOfProfit) : null,
        minProfit: dto.minProfit != null ? new Decimal(dto.minProfit) : null,
