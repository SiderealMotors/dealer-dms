  ...
  async create(dto: CreateExpenseDto) {
      ...
      if (cashAcct) {
        const lines: Prisma.JournalLineCreateManyJournalEntryInput[] = [
          {
            ...
            debitAmount: new Decimal(amountPreTax.toFixed(2)),
        ...
        if (hstAmount > 0 && hstPaidAcct) {
          lines.push({
            ...
            debitAmount: new Decimal(hstAmount.toFixed(2)),
            creditAmount: new Decimal(0),
        ...
        lines.push({
          ...
          creditAmount: new Decimal(totalAmount.toFixed(2)),
    ...
    return this.prisma.expense.create({
      data: {
        ...
        amountPreTax: new Decimal(amountPreTax.toFixed(2)),
        hstAmount: new Decimal(hstAmount.toFixed(2)),
